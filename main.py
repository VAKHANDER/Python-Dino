...
pygame.init()
# Это инициализация звуковой дорожки компьютера
pygame.mixer.init()
    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if width / 2 - 25 <= mouse_pos[0] <= width / 2 + 20 and height / 2 + 140 <= mouse_pos[
                    1] <= height / 2 + 200:
                    # Завершаем работу модулей
                    pygame.quit()
                    # заврешаем работу программы
...
def Game():
    ...
    Dino2 = pygame.image.load('tiles\\Game\\Dino2.png')
    Dino3 = pygame.image.load('tiles\\Game\\Dino3.png')
    ...
    while True:
        ...
        screen.blit(Game_surf1, (x1, 0))
        screen.blit(Game_surf2, (x2, 0))
        if 15 <= Dino_animation <= 20:
            screen.blit(Dino, (100, y_dino))
            Dino_animation = Dino_animation - 1
        elif 10 <= Dino_animation < 15:
            screen.blit(Dino2, (100, y_dino))
            Dino_animation = Dino_animation - 1
        elif 5 <= Dino_animation < 10:
            screen.blit(Dino, (100, y_dino))
            Dino_animation = Dino_animation - 1
        elif 0 <= Dino_animation < 5:
            screen.blit(Dino3, (100, y_dino))
            Dino_animation = Dino_animation - 1
        else:
            Dino_animation = 20
        print(kaktus)
        if kaktus == 1:
            ...
            print("Kaktus spawned")
            kaktus_was_spawned = True
            if x1 < -640:
                kaktus = 0
                kaktus_was_spawned = False
        elif kaktus == 2:
        ...
        x2 = x2 - speed
        score = score + speed
        if (130 == x1 - 25) and kaktus_was_spawned == True:
            kaktus_was_spawned = False
            print(1)
            print((175 == x1 - 25))
            print(y_dino <= 455)
            if y_dino >= 455:
                ...
                Loose()
        elif (60 <= x1 + 25) and (130 >= x1 - 25) and kaktus_was_spawned == True:
            kaktus_was_spawned = False
            print(2)
            print((60 <= x1 + 25))
            print(y_dino >= 455)
...
def Menu2():
    ...
    while True:
        ...
        for event in pygame.event.get():
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_ESCAPE:
                    ...
                    return
            if event.type == pygame.MOUSEBUTTONDOWN:
                if (width / 2 + 40 >= mouse_pos[0] >= width / 2 - 80) and (
                        height / 2 - 90 >= mouse_pos[1] >= height / 2 - 140):
                    pygame.mixer.music.stop()
                    return
                elif (width / 2 + 50 >= mouse_pos[0] >= width / 2 - 70) and (
                        height / 2 + 30 >= mouse_pos[1] >= height / 2 - 20):
                    Settings(width, height)
                elif (width / 2 + 80 >= mouse_pos[0] >= width / 2 - 40) and (
                        height / 2 + 150 >= mouse_pos[1] >= height / 2 + 100):
                    pygame.mixer.music.stop()
                    Menu1(width, height)
        ...
        if (width / 2 + 80 >= mouse_pos[0] >= width / 2 - 40) and (
                height / 2 + 150 >= mouse_pos[1] >= height / 2 + 100):
            color_exit = color_dark
        else:
            color_exit = color_light
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                if (width / 2 - 600 <= mouse_pos[0] <= width / 2 - 550) and (
                    ...
                    screen.blit(tmp_surf, (0, 0))
                    return width, height
                elif (width / 2 - 50 <= mouse_pos[0] <= width / 2) and (
                        height / 2 - 100 < mouse_pos[1] < height / 2 - 50):
                    pygame.display.set_mode((width, height), pygame.FULLSCREEN)
                    screen.blit(Menu1_surf, (0, 0))
                elif (width / 2 + 85 <= mouse_pos[0] <= width / 2 + 135) and (
                        height / 2 - 100 < mouse_pos[1] < height / 2 - 50):
            ...
            if (width / 2 + 85 <= mouse_pos[0] <= width / 2 + 135) and (
                    height / 2 - 100 < mouse_pos[1] < height / 2 - 50):
